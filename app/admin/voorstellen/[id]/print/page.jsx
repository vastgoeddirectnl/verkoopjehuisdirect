...
function formatAddress(proposal) {
  if (proposal.property_address) return proposal.property_address;
      ...
      <article className="page">
        ...
        <section className="section">
          ...
          <div className="table two">
            ...
            <div><strong>Postcode / huisnummer</strong><span>{value([proposal.property_postcode, proposal.property_house_number].filter(Boolean).join(" "))}</span></div>
