  ...
  return (
    <main className="print-root">
      ...
      <article className="page">
        ...
        <h1>Vrijblijvend verkoopvoorstel</h1>
        <p className="lead">
          Beste {proposal.lead_naam || "heer/mevrouw"}, naar aanleiding van uw aanvraag ontvangt u hierbij een persoonlijk en vrijblijvend verkoopvoorstel.
          Dit voorstel is bedoeld om rustig duidelijkheid te geven over bedrag, uitgangspunten, voorwaarden en vervolgstappen.
        </p>
        <p className="subtle">
          Vergelijk niet alleen het bodbedrag, maar vooral de netto-opbrengst, voorwaarden, planning en zekerheid van de verkoop.
        </p>

        <section className="decision-strip">
          <div><strong>Rustig beoordelen</strong><span>Geen directe verplichting.</span></div>
          <div><strong>Vragen bespreken</strong><span>Telefonisch of per e-mail toelichten.</span></div>
          <div><strong>Notariële afwikkeling</strong><span>Afspraken worden zorgvuldig vastgelegd.</span></div>
        </section>
