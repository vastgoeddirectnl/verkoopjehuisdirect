...
const page = {
  ...
  "eyebrow": "Huis verkopen in Borger",
  "h1": "Huis verkopen in Borger zonder makelaar of verkoopstress",
  "lead": "Wilt u uw huis in Borger verkopen en snel duidelijkheid krijgen zonder open huis, makelaarskosten of lange verkoopperiode? Vastgoed Direct Nederland helpt woningeigenaren in Borger en omgeving met een rustige en duidelijke verkoopoplossing.",
  "shortAnswer": "U kunt vrijblijvend een verkoopvoorstel aanvragen voor uw woning in Borger. Wij kijken naar uw situatie, de woning, de gewenste planning en de mogelijkheden voor een directe verkooproute.",
  "benefits": [
  ...
  "sections": [
    {
      "title": "Huis verkopen in Borger: wanneer is dit interessant?",
      "paragraphs": [
        "Een directe verkoopoplossing kan interessant zijn als u in Borger snel duidelijkheid wilt en liever geen traditioneel verkooptraject met meerdere bezichtigingen wilt.",
        "In Borger en omgeving spelen rust, ruimte en woningtype vaak een rol. Ook woningen met onderhoud of een bijzondere situatie kunnen vrijblijvend worden aangemeld."
      ]
    },
    {
  ...
  "faqs": [
    {
      "question": "Kan ik mijn huis in Borger verkopen zonder makelaar?",
  ...
  "keywords": "huis verkopen borger, woning verkopen borger, huis snel verkopen borger, drenthe"
};
