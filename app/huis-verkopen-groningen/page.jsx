...
export const metadata = {
  title: 'Huis verkopen in Groningen | zonder verkoopstress',
  description: 'Huis of woning verkopen in Groningen zonder open huis, verkoopstress of eerst opknappen? Vraag vrijblijvend een verkoopvoorstel aan.',
  alternates: {
...
const page = {
  ...
  lead: "Wilt u uw woning in Groningen verkopen, maar liever zonder lange bezichtigingsrondes of eerst verkoopklaar maken? Wij bekijken rustig uw woning, situatie en gewenste planning.",
  ...
  shortAnswer: "Vraag vrijblijvend een verkoopvoorstel aan voor uw woning in Groningen. Ook bij leegstand, onderhoud, erfenis, verhuur, dubbele lasten of een woning die nog vol staat kunt u rustig bespreken welke verkooproute past.",
  benefits: [
    "Actief in Groningen",
  ...
  practiceExample: {
    ...
    region: "Groningen en de Kanaalstreek",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "In Groningen spelen vaak verschillende situaties tegelijk: dorpswoningen, oudere woningen, leegstand, erfenis, verhuur of onderhoud. Daarom kijken we niet alleen naar de plaats, maar ook naar de staat en de gewenste overdracht.",
