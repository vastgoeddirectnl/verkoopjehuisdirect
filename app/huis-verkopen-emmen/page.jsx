...
export const metadata = {
  title: 'Huis verkopen in Emmen | duidelijke verkooproute',
  description: 'Huis verkopen in Emmen zonder verkoopstress of eerst opknappen? Vraag vrijblijvend een verkoopvoorstel aan.',
  alternates: {
...
const page = {
  ...
  eyebrow: "Regio Emmen",
  h1: "Uw huis verkopen in Emmen zonder onnodige voorbereiding",
  lead: "Wilt u uw woning in Emmen verkopen en zoekt u een praktische route zonder open huis of eerst opknappen? Wij bekijken vrijblijvend wat mogelijk is.",
  ...
  shortAnswer: "Vraag vrijblijvend een verkoopvoorstel aan voor uw woning in Emmen. Ook bij leegstand, onderhoud, erfenis, verhuur, dubbele lasten of een woning die nog vol staat kunt u rustig bespreken welke verkooproute past.",
  benefits: [
    "Actief in Emmen",
  ...
  practiceExample: {
    ...
    region: "Emmen en Zuidoost-Drenthe",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Wij beoordelen woningen in Emmen, Klazienaveen, Nieuw-Amsterdam, Erica, Schoonebeek en Zuidoost-Drenthe.",
    ...
    },
    {
      ...
      paragraphs: [
        "In Zuidoost-Drenthe spelen vaak woningen met ruimte, onderhoud, leegstand of verkoop vanuit een bijzondere situatie. Een duidelijke planning en oplevering zijn dan belangrijk.",
