...
const page = {
  ...
  "eyebrow": "Huis verkopen in Emmen",
  "h1": "Huis verkopen in Emmen zonder makelaar of verkoopstress",
  "lead": "Wilt u uw huis in Emmen verkopen en snel duidelijkheid krijgen zonder open huis, makelaarskosten of lange verkoopperiode? Vastgoed Direct Nederland helpt woningeigenaren in Emmen en omgeving met een rustige en duidelijke verkoopoplossing.",
  "shortAnswer": "U kunt vrijblijvend een verkoopvoorstel aanvragen voor uw woning in Emmen. Wij kijken naar uw situatie, de woning, de gewenste planning en de mogelijkheden voor een directe verkooproute.",
  "benefits": [
    "Huis verkopen in Emmen",
  ...
  "sections": [
    {
      "title": "Huis verkopen in Emmen: wanneer is dit interessant?",
      "paragraphs": [
        "Een directe verkoopoplossing kan interessant zijn als u in Emmen snel duidelijkheid wilt en liever geen traditioneel verkooptraject met meerdere bezichtigingen wilt.",
        "Emmen heeft een brede woningmarkt. Als u niet wilt wachten op een traditioneel traject, kunt u vrijblijvend laten beoordelen welke directe verkoopmogelijkheden er zijn."
      ]
    },
    {
  ...
  "faqs": [
    {
      "question": "Kan ik mijn huis in Emmen verkopen zonder makelaar?",
  ...
  "keywords": "huis verkopen emmen, woning verkopen emmen, huis snel verkopen emmen, drenthe"
};
