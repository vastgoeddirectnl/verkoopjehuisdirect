...
export const metadata = {
  title: 'Woning verkopen in Drenthe | rustig en duidelijk',
  description: 'Woning verkopen in Drenthe zonder open huis, makelaarskosten of eerst verkoopklaar maken? Vraag vrijblijvend een helder voorstel aan.',
  alternates: {
...
const page = {
  ...
  h1: "Uw woning verkopen in Drenthe met duidelijke afspraken",
  lead: "Wilt u uw woning in Drenthe verkopen en eerst weten welke route past? Ook bij onderhoud, leegstand, buitengebied of een woning die nog vol staat kunt u vrijblijvend duidelijkheid aanvragen.",
  ...
  shortAnswer: "Vraag vrijblijvend een verkoopvoorstel aan voor uw woning in Drenthe. Ook bij leegstand, onderhoud, erfenis, verhuur, dubbele lasten of een woning die nog vol staat kunt u rustig bespreken welke verkooproute past.",
  benefits: [
    "Actief in Drenthe",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Wij beoordelen woningen in Assen, Emmen, Borger, Gieten, Aa en Hunze, Midden-Drenthe, de Hondsrug en omliggende dorpen.",
    ...
    },
    {
      ...
      paragraphs: [
        "In Drenthe gaat het regelmatig om vrijstaande woningen, dorpswoningen, voormalige boerderijen en woningen met ruimte of onderhoud. Oplevering, planning en staat van de woning zijn daarbij vaak net zo belangrijk als snelheid.",
