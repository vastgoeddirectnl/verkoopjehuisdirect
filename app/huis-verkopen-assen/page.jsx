...
export const metadata = {
  ...
  "description": "Wilt u uw huis in Assen verkopen zonder open huis of verkoopstress? Vraag vrijblijvend een verkoopvoorstel aan bij Vastgoed Direct Nederland.",
  "alternates": {
