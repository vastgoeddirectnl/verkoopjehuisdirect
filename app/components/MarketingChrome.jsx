  ...
  return (
    <section className="proof-bar" aria-label="Zekerheden en beoordeling">
      <div className="site-container proof-bar-grid">
        ...
        <div className="proof-item">
          <span className="proof-icon">§</span>
          <span><strong>Schriftelijk en notarieel</strong><small>Duidelijke afspraken bij akkoord</small></span>
        </div>
      </div>
    </section>
  );
      ...
      <footer className="marketing-footer">
        <div className="site-container footer-grid">
          ...
          <div>
            ...
            <p><a href="/huis-verkopen-aan-opkoper">Verkopen aan opkoper</a></p>
          </div>
