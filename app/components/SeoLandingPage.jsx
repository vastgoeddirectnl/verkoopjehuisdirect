...
function pageTypeCopy(page) {
  if (page.pageType === "region") {
    return {
      ...
      valueText:
        "Wij kijken naar de ligging én naar de woning, staat, gewenste planning en persoonlijke situatie. Zo krijgt u geen standaardantwoord, maar een verkooproute die praktisch klopt.",
    };
  }
  ...
  if (page.pageType === "situation") {
    return {
      ...
      valueText:
        "Bij erfenis, onderhoud, leegstand, verhuur of een volle woning spelen andere vragen. Daarom kijken wij eerst naar de hele situatie en leggen wij afspraken concreet vast.",
    };
  }
  ...
  return {
    ...
    valueText:
      "Een eerste aanvraag is laagdrempelig. Als directe verkoop passend is, ontvangt u een vrijblijvend verkoopvoorstel met uitleg over bedrag, planning, oplevering en voorwaarden.",
  };
}
...
export default function SeoLandingPage({ page }) {
  ...
  const processIntro = page.processIntro ||
    "De aanvraag is bedoeld om eerst duidelijkheid te krijgen. Een verkoop komt pas tot stand nadat de afspraken zijn uitgewerkt en de koopovereenkomst is ondertekend.";
  ...
  const afterRequestText = page.afterRequestText ||
    "Wij beoordelen de woninggegevens en uw situatie. Als directe verkoop passend is, ontvangt u een vrijblijvend verkoopvoorstel. Ontbreekt er informatie, dan nemen wij persoonlijk contact met u op.";
        ...
        <div className="site-container">
          ...
          <div className="seo-hero-grid">
            ...
            <aside className="seo-form-panel" id="aanvraag">
              ...
              <h2>Vraag een vrijblijvend voorstel aan</h2>
