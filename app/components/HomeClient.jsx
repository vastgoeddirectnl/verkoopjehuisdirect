...
const faqItems = [
  ...
  [
    ...
    "Nee. Ook bij achterstallig onderhoud, schade of spullen in de woning kunt u een aanvraag doen. We bespreken vooraf welke staat en oplevering bij het voorstel horen.",
  ],
  [
    "Krijg ik altijd direct een bod?",
    "Niet iedere woning kan op basis van alleen een adres worden beoordeeld. Waar mogelijk ontvangt u een eerste inschatting of voorstel. Als aanvullende informatie of een opname nodig is, hoort u dat duidelijk.",
  ],
  [
    "Kan reguliere verkoop meer opleveren?",
    "Dat kan. Directe verkoop draait niet alleen om de hoogste mogelijke verkoopprijs, maar ook om tijd, kosten, zekerheid, voorbereiding en oplevering. Daarom leggen we de uitgangspunten helder uit zodat u goed kunt vergelijken.",
  ],
  [
    "Hoe snel nemen jullie contact op?",
    "Doorgaans nemen we binnen één werkdag persoonlijk contact op. De termijn voor een voorstel of overdracht hangt af van de woning, beschikbare informatie en notariële mogelijkheden.",
  ],
  [
...
const situationCards = [
  ...
  },
  {
    ...
    text: "Ook een volle woning kan worden aangemeld. Afspraken over spullen en oplevering maken we expliciet.",
  },
  {
  ...
  },
  {
    ...
    text: "We kijken naar de huursituatie, afspraken, opbrengst en een passende overdrachtsroute.",
  },
];

const processSteps = [
  ["01", "Korte aanvraag", "Adres, type woning en uw situatie zijn genoeg om te starten."],
  ["02", "Persoonlijke beoordeling", "We bekijken de gegevens en nemen doorgaans binnen één werkdag contact op."],
  ["03", "Eerste voorstel", "Waar mogelijk ontvangt u een eerste vrijblijvende inschatting met uitgangspunten."],
  ["04", "Definitieve afspraken", "Na eventuele opname leggen we prijs, planning, oplevering en voorwaarden vast."],
...
const comparisonRows = [
  ...
  ["Voorbereiding", "Vaak opruimen, herstel, styling en fotografie", "Eerste beoordeling in huidige staat"],
  ...
  ["Zekerheid", "Afhankelijk van koper en voorbehouden", "Voorwaarden vooraf schriftelijk duidelijk"],
        ...
        <div className="site-container home-hero-grid">
          <div className="home-hero-copy">
            ...
            <p className="hero-intro">
              U ontvangt eerst een persoonlijk en schriftelijk voorstel. Met duidelijkheid over prijs, planning,
              voorwaarden en oplevering. Daarna beslist u rustig of directe verkoop bij u past.
            </p>
          ...
          <div className="hero-form-wrap">
            <div className="form-context">
              ...
              <strong>In drie korte stappen weten wij genoeg voor een eerste beoordeling.</strong>
            </div>
            <HomeLeadForm />
          </div>
        </div>
      ...
      <section className="section-shell positioning-section">
        <div className="site-container positioning-grid">
          <div>
            ...
            <h2>Geen grootse beloftes. Wel precies weten waar u aan toe bent.</h2>
          </div>
      ...
      <section id="werkwijze" className="section-shell process-section">
        <div className="site-container">
          <div className="section-heading centered-heading">
            ...
            <h2>Vijf heldere stappen. Geen verplichting na stap één.</h2>
      ...
      <section className="section-shell region-section">
        <div className="site-container region-grid">
          <div>
            ...
            <p>
              We kijken naar woningen in steden, dorpen en buitengebieden. De ligging is belangrijk, maar de staat,
