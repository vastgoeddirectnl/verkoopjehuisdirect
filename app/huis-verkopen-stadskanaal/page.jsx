...
const page = {
  ...
  "eyebrow": "Huis verkopen in Stadskanaal",
  "h1": "Huis verkopen in Stadskanaal zonder makelaar of verkoopstress",
  "lead": "Wilt u uw huis in Stadskanaal verkopen en snel duidelijkheid krijgen zonder open huis, makelaarskosten of lange verkoopperiode? Vastgoed Direct Nederland helpt woningeigenaren in Stadskanaal en omgeving met een rustige en duidelijke verkoopoplossing.",
  "shortAnswer": "U kunt vrijblijvend een verkoopvoorstel aanvragen voor uw woning in Stadskanaal. Wij kijken naar uw situatie, de woning, de gewenste planning en de mogelijkheden voor een directe verkooproute.",
  "benefits": [
  ...
  "sections": [
    {
      "title": "Huis verkopen in Stadskanaal: wanneer is dit interessant?",
      "paragraphs": [
        "Een directe verkoopoplossing kan interessant zijn als u in Stadskanaal snel duidelijkheid wilt en liever geen traditioneel verkooptraject met meerdere bezichtigingen wilt.",
        "Stadskanaal en de Kanaalstreek kennen verschillende woningtypes, van gezinswoningen tot oudere woningen met onderhoud of leegstand. Een direct verkoopvoorstel kan dan een overzichtelijke route zijn."
      ]
    },
    {
  ...
  "faqs": [
    {
      "question": "Kan ik mijn huis in Stadskanaal verkopen zonder makelaar?",
  ...
  "keywords": "huis verkopen stadskanaal, woning verkopen stadskanaal, huis snel verkopen stadskanaal, groningen"
};
