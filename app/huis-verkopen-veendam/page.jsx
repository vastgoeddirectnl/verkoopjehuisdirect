...
export const metadata = {
  title: 'Huis verkopen in Veendam | directe duidelijkheid',
  description: 'Huis verkopen in Veendam zonder traditioneel verkooptraject? Vraag vrijblijvend een helder verkoopvoorstel aan.',
  alternates: {
...
const page = {
  ...
  h1: "Uw huis verkopen in Veendam met duidelijke afspraken",
  lead: "Wilt u uw woning in Veendam verkopen zonder open huis, verkoopdruk of eerst verkoopklaar maken? Vraag vrijblijvend duidelijkheid aan.",
  ...
  shortAnswer: "Vraag vrijblijvend een verkoopvoorstel aan voor uw woning in Veendam. Ook bij leegstand, onderhoud, erfenis, verhuur, dubbele lasten of een woning die nog vol staat kunt u rustig bespreken welke verkooproute past.",
  benefits: [
    "Actief in Veendam",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Wij beoordelen woningen in Veendam, Wildervank, Muntendam en omliggende plaatsen.",
    ...
    },
    {
      ...
      paragraphs: [
        "Rond Veendam komen uiteenlopende situaties voor, zoals leegstand, erfenis, dubbele lasten of woningen met onderhoud. Een voorstel werkt alleen goed als de uitgangspunten vooraf duidelijk zijn.",
