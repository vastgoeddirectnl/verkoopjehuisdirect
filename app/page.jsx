    ...
    <>
      <style jsx global>{`
        * { box-sizing: border-box; }
        ...
        .header { position: sticky; top: 0; z-index: 50; background: rgba(255,255,255,0.96); border-bottom: 1px solid #e6e2db; backdrop-filter: blur(10px); }
        .header-inner { height: 82px; display: flex; align-items: center; justify-content: space-between; gap: 24px; }
        .logo { display: block; width: 210px; height: auto; object-fit: contain; }
        ...
        .btn { display: inline-flex; align-items: center; justify-content: center; border-radius: 999px; padding: 14px 22px; font-weight: 900; border: none; cursor: pointer; font-size: 15px; transition: 0.2s ease; white-space: nowrap; }
        .btn-orange { background: #ff6a00; color: #fff; box-shadow: 0 10px 24px rgba(255,106,0,0.25); }
        ...
        .hero { background: radial-gradient(circle at 85% 10%, rgba(255,106,0,0.13), transparent 32%), radial-gradient(circle at 10% 90%, rgba(10,37,64,0.14), transparent 35%), #fff; }
        .hero-grid { display: grid; grid-template-columns: 1.05fr 0.95fr; gap: 54px; align-items: center; padding: 72px 0; }
        ...
        h1 { font-size: clamp(42px, 5.5vw, 72px); line-height: 0.98; letter-spacing: -2px; margin: 0; color: #0a2540; }
        ...
        .trust-card { background: #fff; border: 1px solid #e6e2db; border-radius: 20px; padding: 18px; font-weight: 900; box-shadow: 0 8px 22px rgba(10,37,64,0.06); }
        .hero-buttons { display: flex; gap: 12px; flex-wrap: wrap; }
        .form-card { background: #fff; border: 1px solid #e6e2db; border-radius: 34px; box-shadow: 0 28px 70px rgba(10,37,64,0.16); padding: 32px; }
        ...
        .step-label { margin: 0; color: #ff6a00; font-weight: 900; text-transform: uppercase; letter-spacing: 0.06em; font-size: 13px; }
        .form-title { margin: 6px 0 8px; font-size: 32px; line-height: 1.1; color: #0a2540; }
        .form-sub { margin: 0 0 22px; color: #687789; }
        ...
        .eyebrow { color: #ff6a00; font-weight: 900; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 10px; }
        ...
        .card { background: #fff; border: 1px solid #e6e2db; border-radius: 30px; padding: 30px; box-shadow: 0 18px 44px rgba(10,37,64,0.08); }
        ...
        .dark-box { background: #0a2540; color: #fff; border-radius: 38px; padding: 38px; box-shadow: 0 20px 60px rgba(10,37,64,0.18); }
        ...
        .property { background: rgba(255,255,255,0.1); border-radius: 18px; padding: 16px; font-weight: 800; }
        ...
        .whatsapp-float { position: fixed; right: 22px; bottom: 22px; z-index: 60; background: #25d366; color: #fff; border-radius: 999px; padding: 16px 22px; font-weight: 900; box-shadow: 0 16px 40px rgba(37,211,102,0.35); }
      ...
      <header className="header">
        <div className="container header-inner">
          ...
          <div className="header-actions">
            <a href="https://wa.me/31681158003" target="_blank" rel="noopener noreferrer" className="btn btn-green">WhatsApp</a>
          ...
          <div>
            ...
            <div className="checks">
              {["Geen verkoopstyling nodig", "Geen open huis", "Ook verhuurde woningen", "Direct contact"].map((item) => (
                <div key={item} className="check">✓ {item}</div>
              ))}
            </div>
          </div>
