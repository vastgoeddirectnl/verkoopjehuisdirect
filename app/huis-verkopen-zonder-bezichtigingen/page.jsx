...
const page = {
  ...
  "eyebrow": "Huis verkopen zonder bezichtigingen",
  "h1": "Huis verkopen zonder bezichtigingen of open huis",
  "lead": "Wilt u uw woning verkopen zonder meerdere kijkers, open huis of bezichtigingsrondes? Dan kunt u vrijblijvend een directe verkoopoplossing bespreken.",
  "shortAnswer": "Huis verkopen zonder bezichtigingen, open huis of verkoopstress? U kunt vrijblijvend een helder verkoopvoorstel aan.",
  "benefits": [
  ...
  "sections": [
    {
      "title": "Huis verkopen zonder bezichtigingen: wanneer is dit interessant?",
      "paragraphs": [
        "Wilt u uw woning verkopen zonder meerdere kijkers, open huis of bezichtigingsrondes? Dan kunt u vrijblijvend een directe verkoopoplossing bespreken.",
  ...
  "faqs": [
    {
      "question": "Kan ik mijn huis verkopen zonder bezichtigingen zonder makelaar regelen?",
  ...
  "ctaTitle": "Wilt u huis verkopen zonder bezichtigingen?",
  "ctaText": "Vraag vrijblijvend een verkoopvoorstel aan en ontvang duidelijkheid over uw mogelijkheden.",
  "keywords": "huis verkopen zonder bezichtigingen, woning verkopen zonder open huis, geen kijkers"
};
